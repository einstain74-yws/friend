...
5. [`009_survey_history_items.sql`](supabase/migrations/009_survey_history_items.sql) — **과거 설문 마감** 스냅샷(`survey_history_items`)을 Supabase에 저장해 **다른 PC에서도** 과거 기록이 보이게 합니다.
